...
date: "2026-04-24"
source: "https://blog.17lands.com/posts/bot-signals/"
author:
  - "[[Robert Conroy]]"
description: "Draft is often cited as the biggest test of skills for a Magic player, as there are three distinct areas where a drafter must excel in order to do well: drafting, deckbuilding, and playing. With the advent of Arena, “the bots” have disrupted the drafting component significantly. In this post, we’ll try to explore how bots affect the way we draft, backed up by data from real Arena and Magic Online drafts."
tags:
  - "clipped"
aliases:
---
...
[Invading Manticore](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=461061)

in [this draft](https://www.17lands.com/draft/e688e13849bf46bf9e3a7f07f8fa1242). Throughout the draft, we see it the following times:

- Pack 1 pick 1
- Pack 1 pick 9 (indicating no one took this picks 2 through 8)
- Pack 3 pick 7

For any card that wheels (i.e. we see it again when the pack comes back around), we ignore the first time we saw it. Using just the data from the draft above, the “average available position” for

[Invading Manticore](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=461061)

would be 8.0. Averaging across all the WAR drafts shared using 17Lands, the actual number for

[Invading Manticore](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=461061)

with the Arena bots is 7.6. We also have data from hundreds of Magic Online drafts with human drafters to compare to, provided by [Magic Pro Tools](https://magicprotools.com/). Averaging across those human drafters, that number for

[Invading Manticore](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=461061)

is 6.2. A great card like

[Spark Harvest](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=497670)

is usually only available in the first couple of picks, and its number is 3.0.
...
- P1P2,
	[Tamiyo, Collector of Tales](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=461147)
	adds 0.36 (because it is two colors, we split
- P1P3,
	[Eternal Skylord](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=539360)
	adds 0.79, bringing our total to 1.14.
- P1P4,
	[Thunder Drake](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=651837)
	adds 0.52. Total is 1.66.
- P1P5,
	[Tamiyo’s Epiphany](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=460998)
	adds 0.49, putting the total at 2.15.
...
[![Open Lane Benefit: MTGO](https://blog.17lands.com/assets/img/posts/2019-07-01-bot-signals/open-lane-mtgo.png)](https://blog.17lands.com/assets/img/posts/2019-07-01-bot-signals/open-lane-mtgo.png)
...
[![Open Lane Benefit: Arena](https://blog.17lands.com/assets/img/posts/2019-07-01-bot-signals/open-lane-arena.png)](https://blog.17lands.com/assets/img/posts/2019-07-01-bot-signals/open-lane-arena.png)
...
The most obvious difference in drafting with bots is that their pick order is different. When bots overvalue cards like

[Giant Growth](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=129568)

, drafters don’t have a chance to take it where they feel it should be going, and as a result it’s almost never seen in draft play on Arena. It is hard to notice the absence of something, though, and it not being there in any one draft isn’t that odd. What sticks out like a sore thumb, though, is when cards go way later than they should. There have been some extreme examples in past sets, like

[Gate Colossus](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=563198)

and

[Sauroform Hybrid](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=651908)

in RNA. Since the latest update to the bots, the examples in WAR aren’t quite so bad, but

[Lazotep Plating](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=460986)

and

[Dreadmalkin](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=643082)

are a couple that still seem to stick out.
...
[![Pick Position Variance](https://blog.17lands.com/assets/img/posts/2019-07-01-bot-signals/pick-position-variance.png)](https://blog.17lands.com/assets/img/posts/2019-07-01-bot-signals/pick-position-variance.png)
...
The other thing to note from this graph is that across the entire pick order, the variance is lower. This indicates that the bots likely have a very strict pick order within each color, and they stick to it throughout the draft. Not only do different human drafters have different valuations of the cards, but even an individual drafter’s pick order will change throughout the draft to fill in holes in their deck. For example, someone might be light on two-drops and take

[Kronch Wrangler](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=651904)

over

[Bloom Hulk](https://gatherer.wizards.com/Pages/Card/Details.aspx?multiverseid=461081)

later in the draft, even though the latter is a better card in a vacuum. Given the data presented, though, it’s unlikely the bots make these sorts of in-draft adjustments.
