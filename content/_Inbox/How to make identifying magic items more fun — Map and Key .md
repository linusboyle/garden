...
_Not the magic item the players had in mind._
...
> **_Whenever you would identify a magic item, instead, re-roll the item or its properties on the appropriate magic item table. This can only be done once for any magic item._**
