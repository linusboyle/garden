...
 **2.** Download the latest Obsidian \[\[AppImage\]\] file from the [Obsidian homepage](https://obsidian.md/) and put it somewhere where you can reference later[1](https://amir.rachum.com/obsidian-uri-linux/#fn:1). We’ll use `~/obsidian/`, but this can be anywhere you’d like:
...
 **9.** Run the following[2](https://amir.rachum.com/obsidian-uri-linux/#fn:2) to read our newly created `obsidian.desktop` file (if things break for some reason and you’re trying to debug this process, you can add the `-v` flag to have more detailed output):
...
[![](new-note.jpg)](https://amir.rachum.com/images/posts/obsidian-uri/new-note.jpg)
