...
date: 2024-11-14
source: https://github.com/rbenv/rbenv/wiki/unix-shell-initialization
author: 
tags:
  - clipped
  - linux
...
-   execute a script remotely, e.g. `ssh user@host 'echo $PWD'` or with [Capistrano](https://github.com/capistrano/capistrano/wiki): **non‑login, non‑interactive**
