...
> A **labelled transition system** (LTS) is a tuple (S, Λ, →) where S is a set of states, Λ is a set of labels and → is a relation of labelled transitions (i.e., a subset of S × Λ × S).
